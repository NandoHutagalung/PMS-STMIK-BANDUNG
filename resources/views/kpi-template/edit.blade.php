                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <div>
                        ...
                        <select id="kategori_pegawai" name="kategori_pegawai"
                            ...
                            <option value="Dosen" {{ $template->kategori_pegawai == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                            <option value="Pegawai" {{ $template->kategori_pegawai == 'Pegawai' ? 'selected' : '' }}>Pegawai</option>
                        </select>
