            ...
            return {
                ...
                async loadTemplate() {
                    ...
                    try {
                        ...
                        const tmplRes = await fetch(`{{ route('kpi-nilai.get-template-items') }}?periode_id=${this.periodeId}&kategori_pegawai=Pegawai&jabatan=${encodeURIComponent(this.jabatan)}`);
